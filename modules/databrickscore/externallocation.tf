resource "databricks_external_location" "external_location_engineering_default" {
  ...
  url             = "abfss://${azurerm_storage_container.storage_container_engineering_default.name}@${azurerm_storage_container.storage_container_engineering_default.storage_account_name}.dfs.core.windows.net/"
}
