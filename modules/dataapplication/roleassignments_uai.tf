...
resource "azurerm_role_assignment" "role_assignment_resource_group_app_reader_uai" {
...
resource "azurerm_role_assignment" "role_assignment_resource_group_app_monitoring_reader_uai" {
  description          = "Role assignment to app resource group."
...
resource "azurerm_role_assignment" "role_assignment_key_vault_secrets_officer_uai" {
...
resource "azurerm_role_assignment" "role_assignment_databricks_workspace_reader_uai" {
...
resource "azurerm_role_assignment" "role_assignment_ai_service_uai" {
...
resource "azurerm_role_assignment" "role_assignment_cognitive_services_usages_reader_uai" {
...
resource "fabric_workspace_role_assignment" "workspace_role_assignment_contributor_uai" {
...
resource "azurerm_role_assignment" "role_assignment_storage_container_raw_blob_data_owner_uai" {
...
resource "azurerm_role_assignment" "role_assignment_storage_container_enriched_blob_data_owner_uai" {
...
resource "azurerm_role_assignment" "role_assignment_storage_container_curated_blob_data_owner_uai" {
...
resource "azurerm_role_assignment" "role_assignment_storage_container_workspace_blob_data_owner_uai" {
