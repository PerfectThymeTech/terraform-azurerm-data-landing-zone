module "fabric_capacity" {
  ...
  fabric_capacity_admin_emails = var.service_principal_object_id_terraform_plan == "" ? var.fabric_capacity_details.admin_emails : setunion(var.fabric_capacity_details.admin_emails, [var.service_principal_object_id_terraform_plan])
