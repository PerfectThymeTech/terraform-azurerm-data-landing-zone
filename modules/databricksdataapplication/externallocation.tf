...
resource "databricks_external_location" "external_location_raw" {
  ...
  file_event_queue {
    provided_aqs {
      queue_url = var.storage_queue_ids.raw
    }
  }
}
...
resource "databricks_external_location" "external_location_enriched" {
  ...
  file_event_queue {
    provided_aqs {
      queue_url = var.storage_queue_ids.enriched
    }
  }
}
...
resource "databricks_external_location" "external_location_curated" {
  ...
  file_event_queue {
    provided_aqs {
      queue_url = var.storage_queue_ids.curated
    }
  }
}
...
resource "databricks_external_location" "external_location_workspace" {
  ...
  file_event_queue {
    provided_aqs {
      queue_url = var.storage_queue_ids.workspace
    }
  }
}
